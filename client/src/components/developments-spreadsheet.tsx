...
const columns: ColumnDef[] = [
  ...
  { key: 'lockOff', label: 'Lock Off', group: 'tamano', type: 'boolean', width: '80px' },
  { key: 'dish', label: 'Dish', group: 'tamano', type: 'boolean', width: '60px' },
  { key: 'recDesde', label: 'Desde', group: 'rec', type: 'number', width: '80px' },
  { key: 'recHasta', label: 'Hasta', group: 'rec', type: 'number', width: '80px' },
  { key: 'acabados', label: 'Acabados', group: 'rec', width: '100px' },
  ...
  { key: 'inicioPreventa', label: 'Inicio Preventa', group: 'unidadesM2', width: '110px' },
  { key: 'tiempoTransc', label: 'Tiempo Transc.', group: 'unidadesM2', width: '110px' },
